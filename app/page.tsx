  ...
  return (
    <section className="relative overflow-hidden rounded-b-[2.5rem]">
      <div
        ...
        style={{
          backgroundImage:
            'linear-gradient(rgba(255,255,255,0.74), rgba(255,255,255,0.74)), url("https://images.unsplash.com/photo-1520854221256-17451cc331bf?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")',
        }}
      />
      ...
      <div className="relative mx-auto max-w-5xl px-4 py-20 text-center sm:px-6 lg:px-8 lg:py-28">
        ...
        <p className="mx-auto mt-8 max-w-3xl text-lg leading-9 text-stone-600 sm:text-[1.2rem]">
          Con alegría y gratitud en nuestros corazones queremos invitarte a ser parte de uno de los momentos más importante de nuestras vidas.
        </p>
